...
function Event005:eventFunction()
    ...
    for x = 1, (randomFunction(1, 100, "armageddon event", "events")) do
        table.insert(sequenceBufferTable, {
            ...
            action = function()
                ...
                rndCellX = randomFunction(1, 10, "armageddon evenet", "boardgrid")
                rndCellY = randomFunction(1, 10, "armageddon eveent", "boardgrid")
