local Event073 = Event:extend("Event073")

function Event073:init()
    Event.init(self,
        love.graphics.newImage("/graphics/Event073image.png"),
        "Nihil",
        73,
        "... ... ...",
...
function Event073:drawEventStuff()
...
function Event073:eventFunction()
